...
python3 -m torch.distributed.launch --nproc_per_node=$NGPUS train_src.py -cfg configs/samsung/deeplabv2_r101_src.yaml SOLVER.LAMBDA_LOV 0.75 OUTPUT_DIR results/gta5/r101_g2c_src SOLVER.BATCH_SIZE 8
